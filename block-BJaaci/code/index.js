...
console.log( movies[actors.length - 1].actors[actors.length - 1] )


// 11. Log the name of the second actor (index 1) of the third movie
console.log( movies[actors.length - 1].actors[1] )

// 12. Log all the genres of the third movie
console.log( movies[actors.length - 1].genres )
...
for ( let i of movies ) {
  i.year > 2017 ? console.log( true ) : console.log( false );
}
