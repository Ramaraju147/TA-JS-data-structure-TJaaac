...
console.log(movies[0].genres[genres.length - genres.length]);
...
for (let i = 0; i < movies.length; i++) {
  if (movies[i].genres.length > 1) {
    console.log(`${movies[i].title} has more than one genres`);
  }
}
...
for (let i = 0; i < movies.length; i++) {
  if (movies[i].actors.length > 1) {
    console.log(`${movies[i].title} has more than one actor`);
  }
}
...
for (let i = 0; i < movies.length; i++) {
  if (movies[i].actors.length === 3) {
    console.log(`${movies[i].title} has three actors`);
  }
}
...
for (let i = 0; i < movies.length; i++) {
  if (movies[i].year === 2018) {
    console.log(`${movies[i].title} released in 2018`);
  }
}
